...
class hyperbola(object):
    ...
    def intersect(self, instance, instance2, error = False):
        #This is the key functon
        #return x_axis(object.a, instance.a)
        if self.type == 'Y_axis' and instance.type == 'Y_axis':
            pseudo_cord_y_axis = y_axis_inter(self.a, instance.a , instance2.a)
            return pseudo_cord_y_axis
        elif self.type == 'X_axis' and instance.type == 'X_axis':
            if error:
                pseudo_cord_x_axis = x_axis_inter(self.a, instance.a, instance2.a)
